...
<footer class="site-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-center justify-content-center justify-content-md-around">
                <div class="socials">
            ...
            <div class="col-md-3 d-flex d-md-block flex-column flex-sm-row justify-content-around align-items-center align-items-sm-start">
                <?php if(isset($general->address) && !empty($general->address)) { ?>
            ...
            <div class="col-md-3 d-flex align-items-center justify-content-center justify-content-md-end">
               <div class="ethics-channel">
                <picture>
                    <img 
                        src="<?= base_url("_assets/images/scales.png") ?>"
                        srcset="<?= base_url("_assets/images/scales.png") ?> 1x, <?= base_url("_assets/images/scales@2x.png") ?> 2x"
                        alt="Canal de Ética"
                    >
                </picture>
                <span>
