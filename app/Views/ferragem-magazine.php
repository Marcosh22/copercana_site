...
<main>
    ...
    <section class="page-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="with-underline mx-0" style="margin-bottom: 0;"><?= $page_data->magazine_section_title ?>
                    </h2>
                </div>
                    ...
                    <div class="page-socials-wrapper">
                        ...
                        <div class="page-socials">
                            ...
                            <?php if(isset($socials->magazine->youtube) && !empty($socials->magazine->youtube)) { ?>
                                <a href="<?= $socials->magazine->youtube ?>" class="socials__item" target="_blank" rel="noopener noreferrer" aria-label="Youtube">
                            ...
                            <?php if(isset($socials->magazine->linkedin) && !empty($socials->magazine->linkedin)) { ?>
                                <a href="<?= $socials->magazine->linkedin ?>" target="_blank" class="socials__item" rel="noopener noreferrer" aria-label="LinkedIn">
