...
<main>
    <?php if (isset($page_data)) { ?>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <?php if (isset($page_data->magazine_section_banner) && !empty($page_data->magazine_section_banner)) { ?>
                        <div class="page_banner">
                            <picture>
                                <source media="(max-width: 768px)"
                                    srcset="<?= base_url($page_data->magazine_section_mobile_banner) ?>">
                                <source media="(min-width: 768px)"
                                    srcset="<?= base_url($page_data->magazine_section_banner) ?>">
                                <img src="<?= base_url($page_data->magazine_section_banner) ?>" alt="" class="img-fluid">
                            </picture>
                        </div>
                    <?php } ?>
                </div>
        ...
        <?php if (isset($page_data->magazine_section_show) && $page_data->magazine_section_show == 1) { ?>
            <section class="page-section">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="with-underline text-center mx-0" style="margin-bottom: 0;">
                                <?= $page_data->magazine_section_title ?>
                            </h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h2 class="with-underline text-center" style="margin-bottom: 0;">
                                    <?= $page_data->offers_section_title ?>
                                </h2>
                            </div>
                            <div class="col-12 mt-3">
                            ...
                            <div class="col-12">
                                <div class="offers__carousel">
                                    <?php foreach ($offers as $offer) {
                                        ...
                                        ?>
                                        <div>
                                            <a class="offer" href="<?= base_url($offer->file) ?>" target="_blank"
                                                rel="noopener noreferrer">
                                                <img class="offer__cover" src="<?= base_url($offer->cover); ?>"
                                                    alt="<?= $offer->cover ?>" class="img-fluid">
                                        ...
                                        <a href="<?= $socials->magazine->youtube ?>" class="socials__item" target="_blank"
                                            ...
                                            <svg width="40" height="40" id="Слой_1" x="0px" y="0px" viewBox="0 0 300 300"
                                                ...
                                                <g id="g4189" transform="scale(0.75,0.75)">
                                                    <rect width="400" height="400" id="rect4" style="fill:#ffffff;fill-opacity:1"
                                                        x="0" y="0" ry="200" />
