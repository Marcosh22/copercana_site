<main>
    ...
    <?php
            if( isset($page_data->social_section_show) && 
                $page_data->social_section_show == 1 && 
                isset($general) &&
                (
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h2 class="text-white ml-0 mb-4 mb-md-0"><?= $page_data->social_section_title ?></h2>
                        <div class="page-socials">
                            ...
                            <?php if(isset($general->youtube) && !empty($general->youtube)) { ?>
                                <a href="<?= $general->youtube ?>" class="socials__item" target="_blank" rel="noopener noreferrer" aria-label="Youtube">
                            ...
                            <?php if(isset($general->linkedin) && !empty($general->linkedin)) { ?>
                                <a href="<?= $general->linkedin ?>" target="_blank" class="socials__item" rel="noopener noreferrer" aria-label="LinkedIn">
