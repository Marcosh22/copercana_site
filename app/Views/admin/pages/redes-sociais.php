    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Rádio Copercana</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/18', ['class' => 'my-5']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/18/intro_section_banner") ?>"><i
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/18/intro_section_mobile_banner") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                        ...
                        <h3 class="card-title">Nossa Redes Sociais</h3>
                        <div class="row mb-3">
                            <?php echo form_label('Título', 'social_section_title', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'social_section_title',
                                                'id'   => 'social_section_title',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->social_section_title) ? $page_data->social_section_title : '', ['class' => 'form-control']);?>
                            ...
                            <div class="col-12">
                                <div class="page-action-button d-flex my-4">
                                    <a class="btn btn-success mx-2 my-2"
                                        href="<?= base_url("admin/general") ?>#redes-sociais"><i class="bi bi-plus-square"></i>
                        ...
                        <div class="row mb-5">
                            <?php echo form_label('Exibir seção?', 'social_section_show', ['class' => 'col-sm-2 col-form-label']);?>

                            <div class="col-sm-10">

                                <div class="switch__container">
                                    <?php echo form_checkbox([
                                            'name' => 'social_section_show',
                                            'id'   => 'social_section_show',
                                            'value'   => '1',
                                            'checked' => isset($page_data) && isset($page_data->social_section_show) && $page_data->social_section_show == 1,
                                        ], '1', isset($page_data) && isset($page_data->social_section_show) && $page_data->social_section_show == 1, ['class' => 'switch switch--shadow']);?>

                                    <label for="social_section_show"></label>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
