    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Truck Center</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="card-title">Truck Center</h3>
                        <div class="row mb-3">
                            <?php echo form_label('Banner</br><small>(Recomendado: 1110x300)</small>', 'truckcenter_section_banner', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php if(isset($page_data) && isset($page_data->truckcenter_section_banner) && !empty($page_data->truckcenter_section_banner)) { ?>
                                <div class="banner-preview">
                                    <input type="hidden" name="truckcenter_section_banner"
                                ...
                                <?php echo form_upload([
                                            'name' => 'truckcenter_section_banner',
                                            'id'   => 'truckcenter_section_banner'
                                        ], '', ['class' => 'form-control']);?>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Banner Mobile</br><small>(Recomendado: 860x500)</small>', 'truckcenter_section_mobile_banner', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php if(isset($page_data) && isset($page_data->truckcenter_section_mobile_banner) && !empty($page_data->truckcenter_section_mobile_banner)) { ?>
                                <div class="banner-preview">
                                    <input type="hidden" name="truckcenter_section_mobile_banner"
                                ...
                                <?php } else { ?>
                                <?php echo form_upload([
                                            'name' => 'truckcenter_section_mobile_banner',
                                            'id'   => 'truckcenter_section_mobile_banner'
                                        ], '', ['class' => 'form-control']);?>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Título', 'truckcenter_section_title', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'truckcenter_section_title',
                                                'id'   => 'truckcenter_section_title',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->truckcenter_section_title) ? $page_data->truckcenter_section_title : '', ['class' => 'form-control']);?>

                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Subtítulo', 'truckcenter_section_subtitle', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'truckcenter_section_subtitle',
                                                'id'   => 'truckcenter_section_subtitle',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->truckcenter_section_subtitle) ? $page_data->truckcenter_section_subtitle : '', ['class' => 'form-control']);?>

                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Descrição', 'truckcenter_section_description', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_textarea([
                                            'name' => 'truckcenter_section_description',
                                            'id'   => 'truckcenter_section_description',
                                        ], isset($page_data) && isset($page_data->truckcenter_section_description) ? $page_data->truckcenter_section_description : '', ['class' => 'form-control editor', 'style' => 'height: 100px']);?>

                            </div>
                        </div>
                        <div class="row mb-5">
                            <?php echo form_label('Exibir seção?', 'truckcenter_section_show', ['class' => 'col-sm-2 col-form-label']);?>

                            <div class="col-sm-10">

                                <div class="switch__container">
                                    <?php echo form_checkbox([
                                            'name' => 'truckcenter_section_show',
                                            'id'   => 'truckcenter_section_show',
                                            'value'   => '1',
                                            'checked' => isset($page_data) && isset($page_data->truckcenter_section_show) && $page_data->truckcenter_section_show == 1,
                                        ], '1', isset($page_data) && isset($page_data->truckcenter_section_show) && $page_data->truckcenter_section_show == 1, ['class' => 'switch switch--shadow']);?>

                                    <label for="truckcenter_section_show"></label>
                                </div>
                            </div>
                        </div>

                        <h3 class="card-title">Nossos Serviços e Produtos</h3>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <?php echo form_label('Descrição', 'services_section_description', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_textarea([
                                            'name' => 'services_section_description',
                                            'id'   => 'services_section_description',
                                        ], isset($page_data) && isset($page_data->services_section_description) ? $page_data->services_section_description : '', ['class' => 'form-control editor', 'style' => 'height: 100px']);?>
                            ...
                            <div class="col-12">
                                <div class="page-action-button d-flex my-4">
                                    <a class="btn btn-success mx-2 my-2"
                                        href="<?= base_url("admin/truckcenter/services") ?>"><i class="bi bi-plus-square"></i>
                        ...
                        <h3 class="card-title">Nossa Loja</h3>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="page-action-button d-flex my-4">
                                    <a class="btn btn-success mx-2 my-2"
                                        href="<?= base_url("admin/units/truckcenter") ?>"><i class="bi bi-plus-square"></i>
                                        Visualizar Lojas
                                    </a>
                                </div>
                            </div>
