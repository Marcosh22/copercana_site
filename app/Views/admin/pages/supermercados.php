    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Supermercados</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/13', ['class' => 'my-5']);?>
                        ...
                        <h3 class="card-title">Supermercados</h3>
                        <div class="row mb-3">
                            <?php echo form_label('Banner</br><small>(Recomendado: 1110x300)</small>', 'supermarket_section_banner', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php if(isset($page_data) && isset($page_data->supermarket_section_banner) && !empty($page_data->supermarket_section_banner)) { ?>
                                <div class="banner-preview">
                                    <input type="hidden" name="supermarket_section_banner"
                                ...
                                <?php echo form_upload([
                                            'name' => 'supermarket_section_banner',
                                            'id'   => 'supermarket_section_banner'
                                        ], '', ['class' => 'form-control']);?>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Banner Mobile</br><small>(Recomendado: 860x500)</small>', 'supermarket_section_mobile_banner', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php if(isset($page_data) && isset($page_data->supermarket_section_mobile_banner) && !empty($page_data->supermarket_section_mobile_banner)) { ?>
                                <div class="banner-preview">
                                    <input type="hidden" name="supermarket_section_mobile_banner"
                                ...
                                <?php } else { ?>
                                <?php echo form_upload([
                                            'name' => 'supermarket_section_mobile_banner',
                                            'id'   => 'supermarket_section_mobile_banner'
                                        ], '', ['class' => 'form-control']);?>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Título', 'supermarket_section_title', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'supermarket_section_title',
                                                'id'   => 'supermarket_section_title',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->supermarket_section_title) ? $page_data->supermarket_section_title : '', ['class' => 'form-control']);?>

                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Descrição', 'supermarket_section_description', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_textarea([
                                            'name' => 'supermarket_section_description',
                                            'id'   => 'supermarket_section_description',
                                        ], isset($page_data) && isset($page_data->supermarket_section_description) ? $page_data->supermarket_section_description : '', ['class' => 'form-control editor', 'style' => 'height: 100px']);?>

                            </div>
                        </div>
                        <div class="row mb-5">
                            <?php echo form_label('Exibir seção?', 'supermarket_section_show', ['class' => 'col-sm-2 col-form-label']);?>

                            <div class="col-sm-10">

                                <div class="switch__container">
                                    <?php echo form_checkbox([
                                            'name' => 'supermarket_section_show',
                                            'id'   => 'supermarket_section_show',
                                            'value'   => '1',
                                            'checked' => isset($page_data) && isset($page_data->supermarket_section_show) && $page_data->supermarket_section_show == 1,
                                        ], '1', isset($page_data) && isset($page_data->supermarket_section_show) && $page_data->supermarket_section_show == 1, ['class' => 'switch switch--shadow']);?>

                                    <label for="supermarket_section_show"></label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="page-action-button d-flex my-4">
                                    <a class="btn btn-success mx-2 my-2"
                                        href="<?= base_url("admin/offers") ?>"><i class="bi bi-plus-square"></i>
                                        Visualizar Ofertas
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="page-action-button d-flex my-4">
                                    <a class="btn btn-success mx-2 my-2"
                                        href="<?= base_url("admin/units/supermarket") ?>"><i class="bi bi-plus-square"></i>
                                        Visualizar Lojas
                                    </a>
                                </div>
                            </div>
