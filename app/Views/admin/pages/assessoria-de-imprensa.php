    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Assessoria de Imprensa</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/15', ['class' => 'my-5']);?>
                        ...
                        <h3 class="card-title">Assessoria de Imprensa</h3>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/15/intro_section_banner") ?>"><i
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/15/intro_section_mobile_banner") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
