            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/17', ['class' => 'my-5']);?>
                        ...
                        <h3 class="card-title">Rádio Copercana</h3>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <?php echo form_label('Logo</br><small>(Recomendado: 375x130)</small>', 'intro_section_logo', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/17/intro_section_logo") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                        ...
                        <h3 class="card-title">Sobre a Rádio</h3>
                        <div class="row mb-3">
