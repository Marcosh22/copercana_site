    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cadastro de Currículos</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/20', ['class' => 'my-5']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/20/intro_section_banner") ?>"><i
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/20/intro_section_mobile_banner") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                        ...
                        <div class="row mb-3">
                            <?php echo form_label('Texto CTA', 'intro_section_cta_text', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'intro_section_cta_text',
                                                'id'   => 'intro_section_cta_text',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->intro_section_cta_text) ? $page_data->intro_section_cta_text : '', ['class' => 'form-control']);?>

                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Link CTA', 'intro_section_cta_link', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'intro_section_cta_link',
                                                'id'   => 'intro_section_cta_link',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->intro_section_cta_link) ? $page_data->intro_section_cta_link : '', ['class' => 'form-control']);?>
