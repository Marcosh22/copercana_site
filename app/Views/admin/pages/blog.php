            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/28', ['class' => 'my-5']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_textarea([
                                            ...
                                            'id'   => 'page_description',
                                        ], $page_data && $page_data->page_description ? $page_data->page_description : '', ['class' => 'form-control editor']);?>
