    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tecnologia BioAS</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/24', ['class' => 'my-5']);?>
                        ...
                        <h3 class="card-title">Tecnologia BioAS</h3>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/24/intro_section_banner") ?>"><i
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/24/intro_section_mobile_banner") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                        ...
                        <div class="row mb-3">
                            <?php echo form_label('Logo Empraba</br><small>(Recomendado: 85x85)</small>', 'intro_section_logo', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php if(isset($page_data) && isset($page_data->intro_section_logo) && !empty($page_data->intro_section_logo)) { ?>
                                <div class="banner-preview">
                                    <input type="hidden" name="intro_section_logo"
                                        value="<?= $page_data->intro_section_logo; ?>">
                                    <img src="<?= base_url($page_data->intro_section_logo) ?>" alt="">
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/24/intro_section_logo") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                                            'name' => 'intro_section_logo',
                                            'id'   => 'intro_section_logo'
                                        ], '', ['class' => 'form-control']);?>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('PDF para Download', 'intro_section_file', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php if(isset($page_data) && isset($page_data->intro_section_file) && !empty($page_data->intro_section_file)) { ?>
                                <div class="banner-preview">
                                    <input type="hidden" name="intro_section_file"
                                        value="<?= $page_data->intro_section_file; ?>">
                                    <img src="<?= base_url("admin/pages/make_cover/".$page_data->intro_section_file) ?>" alt="">
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/24/intro_section_file") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                                            'name' => 'intro_section_file',
                                            'id'   => 'intro_section_file'
                                        ], '', ['class' => 'form-control']);?>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <h3 class="card-title">Sobre BioAS</h3>
                        <div class="row mb-3">
                            <?php echo form_label('Título', 'bioas_section_title', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_input([
                                                'name' => 'bioas_section_title',
                                                'id'   => 'bioas_section_title',
                                                'type' => 'text'
                                            ], isset($page_data) && isset($page_data->bioas_section_title) ? $page_data->bioas_section_title : '', ['class' => 'form-control']);?>

                            </div>
                        </div>
                        <div class="row mb-3">
                            <?php echo form_label('Descrição', 'bioas_section_description', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php echo form_textarea([
                                            'name' => 'bioas_section_description',
                                            'id'   => 'bioas_section_description',
                                        ], isset($page_data) && isset($page_data->bioas_section_description) ? $page_data->bioas_section_description : '', ['class' => 'form-control editor', 'style' => 'height: 100px']);?>

                            </div>
                        </div>
                        <div class="row mb-5">
                            <?php echo form_label('Exibir seção?', 'bioas_section_show', ['class' => 'col-sm-2 col-form-label']);?>

                            <div class="col-sm-10">

                                <div class="switch__container">
                                    <?php echo form_checkbox([
                                            'name' => 'bioas_section_show',
                                            'id'   => 'bioas_section_show',
                                            'value'   => '1',
                                            'checked' => isset($page_data) && isset($page_data->bioas_section_show) && $page_data->bioas_section_show == 1,
                                        ], '1', isset($page_data) && isset($page_data->bioas_section_show) && $page_data->bioas_section_show == 1, ['class' => 'switch switch--shadow']);?>

                                    <label for="bioas_section_show"></label>
                                </div>
                            </div>
                        </div>
