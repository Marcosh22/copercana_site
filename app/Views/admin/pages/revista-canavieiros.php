    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Revista Canavieiros</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/pages/update_page/16', ['class' => 'my-5']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/16/intro_section_banner") ?>"><i
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/16/intro_section_mobile_banner") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                        ...
                        <div class="row mb-3">
                            <?php echo form_label('Logo</br><small>(Recomendado: 435x70)</small>', 'intro_section_logo', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/pages/delete_file/16/intro_section_logo") ?>"><i
                                            class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                                <?php echo form_upload([
                        ...
                        <h3 class="card-title">Edições</h3>
                        <div class="row mb-3">
                            ...
                            <div class="col-12">
                                <div class="page-action-button d-flex my-4">
                                    <a class="btn btn-success mx-2 my-2"
                                        href="<?= base_url("admin/magazines") ?>"><i class="bi bi-plus-square"></i>
                                        Visualizar Revistas
                                    </a>
                                </div>
                            </div>
