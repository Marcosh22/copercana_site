    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Novo</h5>
                        ...
                        <?php echo form_open_multipart('admin/files/add_file', ['class' => 'my-5']);?>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-5">
                                <?php echo form_label('Subtítulo<span class="required">*</span>', 'subtitle', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            'name' => 'subtitle',
                                            'id'   => 'subtitle',
                                            'type' => 'text'
                                        ], $form_data && $form_data['subtitle'] ? $form_data['subtitle'] : '', ['class' => 'editor form-control']);?>
