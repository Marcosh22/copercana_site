    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Compartilhamentos</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Adicione e gerencie seus arquivos</p>
                        <div class="page-action-button d-flex my-4">
                            <a class="btn btn-success mx-2 my-2" href="<?= base_url("admin/files/add_new") ?>"><i
                                    class="bi bi-plus-square"></i> Adicionar Novo</a>
                        </div>
                        ...
                        <?php }
                            ?>
                        <table class="table datatable" data-ssr="<?= base_url("api/datatables/files") ?>">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
