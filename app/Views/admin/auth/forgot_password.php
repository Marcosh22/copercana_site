                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                          ...
                                          <?php echo lang('Auth.forgot_password_heading');?></h5>
                                        <p class="text-center small"><?php echo sprintf(lang('Auth.forgot_password_subheading'), $identity_label);?></p>
                                    </div>
                                    ...
                                    <?php echo form_open('auth/forgot_password', ['class' => 'row g-3', 'novalidate' => 'true']);?>

                                    <div class="col-12">
                                        <?php echo form_label((($type === 'email') ? sprintf(lang('Auth.forgot_password_email_label'), $identity_label) : sprintf(lang('Auth.forgot_password_identity_label'), $identity_label)), 'identity', ['class' => 'form-label']);?>
                                        <?php echo form_input($identity, '', ['class' => 'form-control']);?>
                                    </div>

                                    <div class="col-12">
                                        <?php echo form_submit('submit', lang('Auth.forgot_password_submit_btn'), ['class' => 'btn btn-primary w-100']);?>
                                    </div>
                                    <?php echo form_close();?>
