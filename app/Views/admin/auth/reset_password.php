                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                          <h5 class="card-title text-center pb-0 fs-4"><?php echo lang('Auth.reset_password_heading');?></h5>
                                    </div>
                                    ...
                                    <?php echo form_open('auth/reset_password', ['class' => 'row g-3', 'novalidate' => 'true']);?>

                                    <div class="col-12">
                                        <?php echo form_label(sprintf(lang('Auth.reset_password_new_password_label'), $minPasswordLength), '', ['class' => 'form-label']);?>
                                        <?php echo form_input($new_password, '', ['class' => 'form-control']);?>
                                    </div>

									<div class="col-12">
                                        <?php echo form_label(lang('Auth.reset_password_new_password_confirm_label'), 'new_password_confirm', ['class' => 'form-label']);?>
                                        <?php echo form_input($new_password_confirm, '', ['class' => 'form-control']);?>
                                    </div>

                                    <div class="col-12">
                                        <?php echo form_submit('submit', lang('Auth.reset_password_submit_btn'), ['class' => 'btn btn-primary w-100']);?>
                                    </div>
                                    <?php echo form_close();?>
