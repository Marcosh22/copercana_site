            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <?php echo form_label('Tipo<span class="required">*</span>', 'group', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                <?php 
                                ...
                                ?>
                                <?php echo form_dropdown('group', $groups_options, '1', ['class' => 'form-control', 'required' => 'required', 'id' => 'group']);?>
