            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Insira as informações atualizados do Depoimento:</p>
                        ...
                        <?php echo form_open_multipart('admin/testimonials/update_testimonial/'.$testimonial->id, ['class' => 'my-5']);?>
                        
                        <div class="row mb-3">
                                <?php echo form_label('Foto</br><small>(Recomendado: 200x200)</small>', 'picture', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                <?php if(isset($testimonial->picture) && !empty($testimonial->picture)) { ?>
                                <div class="banner-preview">
                                    <img src="<?= base_url($testimonial->picture) ?>" alt="">
                                    <a class="delete-btn" href="<?= base_url("admin/testimonials/remove_picture/".$testimonial->id) ?>"><i class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                                ...
                                                'id'   => 'name',
                                                'type' => 'text'
                                            ], $testimonial->name, ['class' => 'form-control', 'required' => 'required']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_input([
                                            ...
                                            'id'   => 'title',
                                            'type' => 'text'
                                        ], $testimonial->title, ['class' => 'form-control', 'required' => 'required']);?>

                            </div>
                        </div>
                      
                        <div class="row mb-5">
                                <?php echo form_label('Depoimento', 'testimonial', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_textarea([
                                            'name' => 'testimonial',
                                            'id'   => 'testimonial',
                                        ], $testimonial->testimonial, ['class' => 'editor form-control']);?>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="switch__container">
                                    <?php echo form_checkbox([
                                            ...
                                            'id'   => 'status',
                                            'value'   => '1',
                                            'checked' => $testimonial->status == 1,
                                        ], '1', $testimonial->status == 1, ['class' => 'switch switch--shadow']);?>
