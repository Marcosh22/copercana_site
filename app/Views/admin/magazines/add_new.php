    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url("admin/magazine") ?>">Revistas</a></li>
                <li class="breadcrumb-item active">Adicionar Revista</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Nova Revista</h5>
                        <p>Insira as informações do sua nova revista:</p>
                        ...
                        <?php echo form_open_multipart('admin/magazines/add_magazine', ['class' => 'my-5']);?>
