    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Novo Expositor</h5>
                        <p>Insira as informações do expositor:</p>
                        ...
                        <?php echo form_open_multipart('admin/exhibitors/add_exhibitor', ['class' => 'my-5'], ['author_id' =>  $logged_user->row()->id]);?>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('sector_id', $sector_options, $form_data && $form_data['sector_id'] ? $form_data['sector_id'] : '', ['class' => 'form-control', 'required' => 'required', 'id' => 'category_id']);?>
