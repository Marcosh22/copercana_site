    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Novo Setor</h5>
                        <p>Insira as informações do setor:</p>
                        ...
                        <?php echo form_open_multipart('admin/exhibitors/add_sector', ['class' => 'my-5'], ['author_id' =>  $logged_user->row()->id]);?>
                        <div class="row mb-3">
                            <?php echo form_label('Mapa do setor<span class="required">*</span>', 'map', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
