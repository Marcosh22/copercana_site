    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Expositores</h5>
                        <p>Adicione e gerencie os expositores da feira</p>
                        <div class="page-action-button d-flex my-4">
                            <a class="btn btn-success mx-2 my-2" href="<?= base_url("admin/exhibitors/add_new") ?>"><i
                                    class="bi bi-plus-square"></i> Adicionar Novo Expositor</a>
                        </div>
                        ...
                        <?php }
                            ?>
                        <table class="table datatable" data-ssr="<?= base_url("api/datatables/exhibitors") ?>">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
