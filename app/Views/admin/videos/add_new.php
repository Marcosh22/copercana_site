            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Insira as informações do seu novo vídeo:</p>
                        ...
                        <?php echo form_open('admin/videos/add_video', ['class' => 'my-5']);?>
                        <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'url',
                                            'type' => 'text'
                                        ], $form_data && $form_data['url'] ? $form_data['url'] : '', ['class' => 'form-control', 'required' => 'required']);?>
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'subtitle',
                                            'type' => 'text'
                                        ], $form_data && $form_data['subtitle'] ? $form_data['subtitle'] : '', ['class' => 'form-control', 'required' => 'required']);?>
