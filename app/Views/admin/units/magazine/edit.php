<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url("admin/units/magazine") ?>">Ferragem e Magazine</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/units/update_unit/'.$unit->id, ['class' => 'my-5'], ['type' => 'magazine']);?>
                        <div class="row mb-3">
                        <?php echo form_label('Foto<span class="required">*</span></br><small>(Recomendado: 450×330)</small>', 'cover', ['class' => 'col-sm-2 col-form-label']);?>
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn"
                                        href="<?= base_url("admin/units/remove_picture/magazine/".$unit->id) ?>"><i
