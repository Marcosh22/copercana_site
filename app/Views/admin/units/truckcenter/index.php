    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Truck Center</h5>
                        <p>Adicione e gerencie suas unidades</p>
                        <div class="page-action-button d-flex my-4">
                            <a class="btn btn-success mx-2 my-2" href="<?= base_url("admin/units/truckcenter/add_new") ?>"><i
                        ...
                        <?php }
                            ?>
                        <table class="table datatable" data-ssr="<?= base_url("api/datatables/units/truckcenter") ?>">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
