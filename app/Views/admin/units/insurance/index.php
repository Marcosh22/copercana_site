                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="page-action-button d-flex my-4">
                            <a class="btn btn-success mx-2 my-2" href="<?= base_url("admin/units/insurance/add_new") ?>"><i
                        ...
                        <?php }
                            ?>
                        <table class="table datatable" data-ssr="<?= base_url("api/datatables/units/insurance") ?>">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
