<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url("admin/units/insurance") ?>">Seguros</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/units/update_unit/'.$unit->id, ['class' => 'my-5'], ['type' => 'insurance']);?>
                        <div class="row mb-3">
                        <div class="row mb-3">
