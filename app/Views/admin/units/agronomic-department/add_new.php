            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/units/add_unit', ['class' => 'my-5'], ['type' => 'agronomic-department']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_textarea([
                                        ...
                                        isset($form_data['definition']['responsible']) ? $form_data['definition']['responsible'] : '', ['class' => ' editor form-control']);?>
