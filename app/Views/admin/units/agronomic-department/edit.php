...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Departamento Agronômico</h1>
        <nav>
        <ol class="breadcrumb">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item"><a href="<?= base_url("admin/units/agronomic-department") ?>">Departamento Agronômico</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/units/update_unit/'.$unit->id, ['class' => 'my-5'], ['type' => 'agronomic-department']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <?php echo form_label('Responsáveis', 'responsible', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_textarea([
                                            'name' => 'definition[responsible]'
                                        ], 
                                        isset($definition) && isset($definition->responsible) ? $definition->responsible : '', ['class' => ' editor form-control']);?>
