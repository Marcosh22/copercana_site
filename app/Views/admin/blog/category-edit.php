    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url("admin/blog/categories") ?>">Categorias</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Insira as informações atualizadas da categoria:</p>
                        ...
                        <?php echo form_open('admin/post/update_category/'.$category->id, ['class' => 'my-5']);?>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'title',
                                            'type' => 'text'
                                        ], $category->title ? $category->title : '', ['class' => 'form-control', 'required' => 'required']);?>
