            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('admin/post/add_post', ['class' => 'my-5'], ['author_id' =>  $logged_user->row()->id]);?>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('category_id', $category_options, $form_data && $form_data['category_id'] ? $form_data['category_id'] : '', ['class' => 'form-control', 'required' => 'required', 'id' => 'category_id']);?>
