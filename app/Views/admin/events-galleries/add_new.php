    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Nova Galeria</h5>
                        <p>Insira as informações da sua nova galeria:</p>
                        ...
                        <?php echo form_open_multipart('admin/events_galleries/add_gallery', ['class' => 'my-5']);?>
                            <div class="row mb-3">
                                <?php echo form_label('Capa <small>(Max.: 5MB)</small><span class="required">*</span></br><small>(Recomendado: 350x350)</small>', 'cover', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        if(isset($form_data['date']) && !empty($form_data['date'])) {
                                            $date = new DateTime($form_data['date']);
