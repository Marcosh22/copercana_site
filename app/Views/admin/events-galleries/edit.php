    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url("admin/events_galleries") ?>">Galerias</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Insira as informações atualizados da sua galeria:</p>
                        ...
                        <?php echo form_open_multipart('admin/events_galleries/update_gallery/'.$gallery->id, ['class' => 'my-5']);?>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="banner-preview">
                                    ...
                                    <a class="delete-btn" href="<?= base_url("admin/events_galleries/remove_cover/".$gallery->id) ?>"><i class="bi bi-x-circle-fill"></i></a>
                                </div>
                                <?php } else { ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_input([
                                            ...
                                            'id'   => 'title',
                                            'type' => 'text'
                                        ], $gallery->title, ['class' => 'form-control', 'required' => 'required']);?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="pictures-list js-sortable">
                                            <?php foreach($pictures as $picture) { ?>
                                                <div class="picture" data-id="<?= $picture->id ?>">
                                                    <img src="<?= base_url($picture->thumbnail) ?>" alt="">
                                                    <a class="delete-btn" href="<?= base_url("admin/events_galleries/delete_picture/$gallery->id/$picture->id") ?>"><i class="bi bi-x-circle-fill"></i></a>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-5">
                            <?php echo form_label('Exibir galeria?', 'status', ['class' => 'col-sm-2 col-form-label']);?>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="switch__container">
                                    <?php echo form_checkbox([
                                        ...
                                        ], '1', $gallery->status == 1, ['class' => 'switch switch--shadow']);?>
