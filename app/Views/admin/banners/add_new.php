    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Novo Banner</h5>
                        <p>Insira as informações do seu novo banner:</p>
                        ...
                        <?php echo form_open_multipart('admin/banners/add_banner', ['class' => 'my-5'], ['page_id' => 1]);?>
                            <div class="row mb-3">
                                <?php echo form_label('Banner desktop<span class="required">*</span></br><small>(Recomendado: 1110×300)</small>', 'desktop_picture', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <?php echo form_label('Banner mobile<span class="required">*</span></br><small>(Recomendado: 860x860)</small>', 'mobile_picture', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_upload([
                                            'name' => 'mobile_picture',
                                            'id'   => 'mobile_picture'
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'link',
                                            'type' => 'text'
                                        ], $form_data && $form_data['link'] ? $form_data['link'] : '', ['class' => 'form-control']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('link_target', $link_target_options, $form_data && $form_data['link_target'] ? $form_data['link_target'] : '', ['class' => 'form-control', 'id' => 'link_target']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'show_order',
                                            'type' => 'number'
                                        ], $form_data && $form_data['show_order'] ? $form_data['show_order'] : $next_order, ['class' => 'form-control', 'required' => 'required', 'min' => '1']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        if(isset($form_data['starts_at']) && !empty($form_data['starts_at'])) {
                                            $starts_at = new DateTime($form_data['starts_at']);
                                            $starts_at_input =  $starts_at->format('Y-m-d\TH:i:s');
                                        } else {
                                            $starts_at_input = "";
                                        }
                                    ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        if(isset($form_data['ends_at']) && !empty($form_data['ends_at'])) {
                                            $ends_at = new DateTime($form_data['ends_at']);
                                            $ends_at_input =  $ends_at->format('Y-m-d\TH:i:s');
                                        } else {
                                            $ends_at_input = "";
                                        }
                                    ?>
