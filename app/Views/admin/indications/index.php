            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Adicione e gerencie suas Indicações</p>
                        <div class="page-action-button d-flex my-4">
                            <a class="btn btn-success mx-2 my-2" href="<?= base_url("admin/indications/add_new") ?>"><i
                                    class="bi bi-plus-square"></i> Adicionar Nova Indicação</a>
                        </div>
                        ...
                        <?php }
                            ?>
                        <table class="table datatable" data-ssr="<?= base_url("api/datatables/indications") ?>">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
