    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url("admin/jobs/roles") ?>">Cargos</a></li>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Editar Cargo</h5>
                        <p>Insira as informações atualizadas do cargo:</p>
                        ...
                        <?php echo form_open('admin/jobs/update_role/'.$role->id, ['class' => 'my-5']);?>
                            <div class="row mb-3">
                                <?php echo form_label('Cargo<span class="required">*</span>', 'title', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            'name' => 'title',
                                            'id'   => 'title',
                                            'type' => 'text'
                                        ], $role->title ? $role->title : '', ['class' => 'form-control', 'required' => 'required']);?>
