    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Novo Cargo</h5>
                        <p>Insira as informações do Cargo:</p>
                        ...
                        <?php echo form_open('admin/jobs/add_role', ['class' => 'my-5'], ['author_id' =>  $logged_user->row()->id]);?>
                        <div class="row mb-3">
