    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Adicionar Nova Vaga</h5>
                        <p>Insira as informações da vaga:</p>
                        ...
                        <?php echo form_open('admin/jobs/add_job', ['class' => 'my-5']);?>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('role_id', $roles_options, $form_data && $form_data['role_id'] ? $form_data['role_id'] : '', ['class' => 'form-control searchable', 'required' => 'required', 'id' => 'role_id']);?>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <?php echo form_label('Cargo Relacionado 1', 'related_role_01_id', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_dropdown('related_role_01_id', $roles_options, $form_data && $form_data['related_role_01_id'] ? $form_data['related_role_01_id'] : '', ['class' => 'form-control searchable', 'id' => 'related_role_01_id']);?>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <?php echo form_label('Cargo Relacionado 2', 'related_role_02_id', ['class' => 'col-sm-2 col-form-label']);?>
                                <div class="col-sm-10">
                                    <?php echo form_dropdown('related_role_02_id', $roles_options, $form_data && $form_data['related_role_02_id'] ? $form_data['related_role_02_id'] : '', ['class' => 'form-control searchable', 'id' => 'related_role_02_id']);?>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('branch_id', $branches_options, $form_data && $form_data['branch_id'] ? $form_data['branch_id'] : '', ['class' => 'form-control searchable', 'required' => 'required', 'id' => 'branch_id']);?>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('type', $type_options, $form_data && $form_data['type'] ? $form_data['type'] : '', ['class' => 'form-control', 'required' => 'required', 'id' => 'type']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'activity',
                                            'type' => 'text'
                                        ], $form_data && $form_data['activity'] ? $form_data['activity'] : '', ['class' => 'form-control']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'quantity',
                                            'type' => 'number'
                                        ], $form_data && $form_data['quantity'] ? $form_data['quantity'] : '', ['class' => 'form-control', 'required' => 'required']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input([
                                            ...
                                            'id'   => 'workload',
                                            'type' => 'text'
                                        ], $form_data && $form_data['workload'] ? $form_data['workload'] : '', ['class' => 'form-control']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('modality', $modality_options, $form_data && $form_data['modality'] ? $form_data['modality'] : '', ['class' => 'form-control', 'required' => 'required', 'id' => 'modality']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    ?>
                                    <?php echo form_dropdown('grade', $grade_options, $form_data && $form_data['grade'] ? $form_data['grade'] : '', ['class' => 'form-control searchable', 'required' => 'required', 'id' => 'grade']);?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_textarea([
                                            'name' => 'description',
                                            'id'   => 'description',
                                        ], $form_data && $form_data['description'] ? $form_data['description'] : '', ['class' => 'editor form-control']);?>
