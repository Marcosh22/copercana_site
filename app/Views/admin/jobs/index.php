            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Adicione e gerencie as Vagas de Emprego</p>
                        <div class="page-action-button d-flex my-4">
                            <a class="btn btn-success mx-2 my-2" href="<?= base_url("admin/jobs/add_new") ?>"><i
                                    class="bi bi-plus-square"></i> Adicionar Nova Vaga</a>
                        </div>
                        ...
                        <?php }
                            ?>
                        <table class="table datatable" data-ssr="<?= base_url("api/datatables/jobs") ?>">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
