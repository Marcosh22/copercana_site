...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- ======= Páginas ======= -->
      <li class="nav-item">
        <a class="nav-link <?= $page !== 'pages-home' && $page !== 'pages-institucional' && $page !== 'pages-sustentabilidade' && $page !== 'pages-cooperativismo' && $page !== 'pages-politica-de-privacidade' && $page !== 'pages-autocenter' && $page !== 'pages-centro-de-eventos' && $page !== 'pages-distribuidora-de-combustiveis' && $page !== 'pages-ferragem-magazine' && $page !== 'pages-postos-de-combustiveis' && $page !== 'pages-copercana-solar' && $page !== 'pages-copercana-seguros' && $page !== 'pages-supermercados' && $page !== 'pages-unidade-de-graos' && $page !== 'pages-assessoria-de-imprensa' && $page !== 'pages-revista-canavieiros' && $page !== 'pages-radio-copercana' && $page !== 'pages-redes-sociais' && $page !== 'pages-indicacoes' && $page !== 'pages-cadastro' && $page !== 'pages-jovem-aprendiz' && $page !== 'pages-vagas-disponiveis' && $page !== 'pages-laboratorio-de-solos' && $page !== 'pages-tecnologia-bioas' && $page !== 'pages-departamento-agronomico' && $page !== 'pages-noticias' && $page !== 'pages-blog' && $page !== 'pages-contato' && $page !== 'pages-soucooperado' && $page !== 'pages-copercana-60-anos' && $page !== 'pages-relatorio-de-transparencia' ? 'collapsed' : null ?>" data-bs-target="#pages-nav" data-bs-toggle="collapse">
        <i class="bi bi-file-earmark-code"></i><span>Páginas</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="pages-nav" class="nav-content collapse <?= $page === 'pages-home' || $page === 'pages-institucional' || $page === 'pages-sustentabilidade' || $page === 'pages-cooperativismo' || $page === 'pages-politica-de-privacidade' || $page === 'pages-autocenter' || $page === 'pages-centro-de-eventos' || $page === 'pages-distribuidora-de-combustiveis' || $page === 'pages-ferragem-magazine' || $page === 'pages-postos-de-combustiveis' || $page === 'pages-copercana-solar' || $page === 'pages-copercana-seguros' || $page === 'pages-supermercados' || $page === 'pages-unidade-de-graos' || $page === 'pages-assessoria-de-imprensa' || $page === 'pages-revista-canavieiros' || $page === 'pages-radio-copercana' || $page === 'pages-redes-sociais' || $page === 'pages-indicacoes' || $page === 'pages-cadastro' || $page === 'pages-jovem-aprendiz' || $page === 'pages-vagas-disponiveis' || $page === 'pages-laboratorio-de-solos' || $page === 'pages-tecnologia-bioas' || $page === 'pages-departamento-agronomico' || $page === 'pages-noticias' || $page === 'pages-contato' || $page === 'pages-soucooperado' || $page === 'pages-copercana-60-anos' || $page === 'pages-relatorio-de-transparencia' ? 'show' : null ?>" data-bs-parent="#sidebar-nav">
          <li>
          ...
          <li>
            <a href="<?= base_url("admin/pages/relatorio-de-transparencia") ?>" <?= $page === 'pages-relatorio-de-transparencia' ? 'class="active"' : null ?>>
              <i class="bi bi-circle"></i><span>Relatório de Transparência</span>
            </a>
          </li>
