...
<main>
    <?php if(isset($page_data)) { ?>
        <?php if(isset($page_data->autocenter_section_show) && $page_data->autocenter_section_show == 1) { ?>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <?php if(isset($page_data->autocenter_section_banner) && !empty($page_data->autocenter_section_banner)) { ?>
                            <div class="page_banner">
                                <picture>
                                    <source media="(max-width: 768px)" srcset="<?= base_url($page_data->autocenter_section_mobile_banner) ?>">
                                    <source media="(min-width: 768px)" srcset="<?= base_url($page_data->autocenter_section_banner) ?>">
                                    <img src="<?= base_url($page_data->autocenter_section_banner) ?>" alt="" class="img-fluid">
                                </picture>
                            </div>
                        <?php } ?>
                    </div>
            ...
            <section class="page-section">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="with-underline mx-0" style="margin-bottom: 0;"><?= $page_data->autocenter_section_title ?></h2>
                        </div>
                        
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="ck-reset autocenter_description">
                                <?= $page_data->autocenter_section_description ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php
            if(
                ...
                (
                    (isset($socials->autocenter->facebook) && !empty($socials->autocenter->facebook)) ||
                    (isset($socials->autocenter->instagram) && !empty($socials->autocenter->instagram)) ||
                    (isset($socials->autocenter->youtube) && !empty($socials->autocenter->youtube)) ||
                    (isset($socials->autocenter->linkedin) && !empty($socials->autocenter->linkedin))
                )
            ) { ?>
                ...
                <div class="col-12">
                    <div class="page-socials-wrapper">
                        ...
                        <div class="page-socials">
                            <?php if(isset($socials->autocenter->facebook) && !empty($socials->autocenter->facebook)) { ?>
                            <a href="<?= $socials->autocenter->facebook ?>" target="_blank" class="socials__item"
                                aria-label="Facebook">
                            ...
                            <?php } ?>
                            <?php if(isset($socials->autocenter->instagram) && !empty($socials->autocenter->instagram)) { ?>
                            <a href="<?= $socials->autocenter->instagram ?>" target="_blank" class="socials__item"
                            ...
                            <?php } ?>
                            <?php if(isset($socials->autocenter->youtube) && !empty($socials->autocenter->youtube)) { ?>
                                <a href="<?= $socials->autocenter->youtube ?>" class="socials__item" target="_blank" rel="noopener noreferrer" aria-label="Youtube">
                            ...
                            <?php } ?>
                            <?php if(isset($socials->autocenter->linkedin) && !empty($socials->autocenter->linkedin)) { ?>
                                <a href="<?= $socials->autocenter->linkedin ?>" target="_blank" class="socials__item" rel="noopener noreferrer" aria-label="LinkedIn">
