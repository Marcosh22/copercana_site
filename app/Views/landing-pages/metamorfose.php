    ...
    <div id="centralSuporte">
        ...
        <div id="Botão1">
            <div class="guia_suporte">
                <h1 class="central_titulo">Guia de Suporte</h1>
                <a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Guia de Suporte para Usuários SAP.pptx"); ?>" target="_blank">
        ...
        <div id="Botão2">
            <div class="guia_suporte2">
                <h1 class="central_titulo">Lista de Contatos</h1>
                <a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Contatos Agentes e Local Operação Assistida.xlsx"); ?>"
                    target="_blank">
