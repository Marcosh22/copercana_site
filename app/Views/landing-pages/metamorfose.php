...
<body>
        ...
        <div class="logo-container">
            <div class="logo">
                <a href="<?= base_url("metamorfose") ?>" style="color: inherit; text-decoration: none;">
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Logo.png"); ?>" alt="Minha Logo"
                        class="logo-image">
                </a>
            </div>
        ...
        <div class="content-container">
            <div class="content-box">
                <button onclick="window.location.href='#informacoesSAP';" class="custom-button">
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/BtnInformacoesSAP 2.png"); ?>"
                        alt="Imagem 1" class="button-image">
                </button>
            </div>
            <div class="content-box">
                <button onclick="window.location.href='#manualUso';" class="custom-button">
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/BtnManualUso 2.png"); ?>"
                        alt="Imagem 2" class="button-image">
                </button>
            </div>
            <div class="content-box">
                <button onclick="window.location.href='#comoAcessar';" class="custom-button">
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/BtnComoAcessar 1.png"); ?>"
                        alt="Imagem 3" class="button-image">
                </button>
            </div>
            <div class="content-box">
                <button onclick="window.location.href='#centralSuporte';" class="custom-button">
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/BtnCentralSuporte 1.png"); ?>"
                        alt="Imagem 4" class="button-image">
                </button>
            </div>
        </div>
    </div>
    <!-- Contagem Regressiva -->
    <div id="container">
        <h1 class="Titulo_contador">Contagem regressiva para o GO LIVE</h1>
        <div id="contador"></div>
        <div id="video-container" style="display: none;">
            <video id="video" width="680" height="480" controls>
                <source src="<?= base_url("_assets/landing-pages/metamorfose/video/VT-MissaoMeta_bx.mp4"); ?>"
                    type="video/mp4">
            </video>
    ...
    <div class="apresentação">
        ...
        <div id="informacoesSAP">
            <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Separacao01.png"); ?>" alt="Separacao01"
                class="imagem-ajuste">
        </div>
    </div>
    ...
    <div class="SobreSap">
        ...
        <img src="<?= base_url("_assets/landing-pages/metamorfose/images/TextoMaior01.png"); ?>" alt="textoMaior"
            class="Tesxte_Maior">
        <img src="<?= base_url("_assets/landing-pages/metamorfose/images/TextoMaior.png"); ?>" alt="texto_Maior"
            class="Tesxte_Maior1">
    </div>
    ...
    <div class="cronograma">
        ...
        <p class="texto_2">
            Esse cronograma é nossa estratégia detalhada para garantir uma transição suave para o novo sistema SAP. Este
            plano inclui todas as etapas necessárias para migrar dados e processos do sistema antigo para o novo,
            garantindo que tudo funcione perfeitamente desde o primeiro dia.
        </p>
        <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Group 2.png"); ?>" alt="local_cronograma"
            class="local_cronograma1">
    </div>
    <!-- Manual SAP -->
    <div class="cotender_sap">
        <div class="imagem">
            <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Separacao01.png"); ?>" alt="separacao02"
                class="local_manual_sap">
        </div>
        <div class="titulo">
            <div id="manualUso">
        ...
        <div class="botoes">
            <div>
                <a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Navegação Básica SAP GUI.pdf"); ?>"
                    target="_blank">
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/ButtonsMedium.png"); ?>"
                        alt="Visualizar Manual">
                </a>
            </div>
            <div>
            ...
            <a id="open-popup" href="#">
                <img src="<?= base_url("_assets/landing-pages/metamorfose/images/ButtonsMedium2.png"); ?>"
                    alt="Download Glossário" class="Download1">
            </a>
            <div id="popup" class="popup">
                <div class="popup-content">
                    <span id="close-popup" class="close-popup">&times;</span>
                    <h1 class="titulopopup">Glossário SAP</h1>
                    <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Separacao01.png"); ?>"
                        alt="Glossário SAP" class="popup-image">
                    <ul class="download-menu">
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - BP.pdf"); ?>"
                                target="_blank">Glossário
                                - BP</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - CO.pdf"); ?>"
                                target="_blank">Glossário
                                - CO</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - CS.pdf"); ?>"
                                target="_blank">Glossário
                                - CS</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - EWM e WM.pdf"); ?>"
                                target="_blank">Glossário - EWM e WM</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - FI.pdf"); ?>"
                                target="_blank">Glossário
                                - FI</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - MM.pdf"); ?>"
                                target="_blank">Glossário
                                - MM</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - PM.pdf"); ?>"
                                target="_blank">Glossário
                                - PM</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - PP.pdf"); ?>"
                                target="_blank">Glossário
                                - PP</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - PS.pdf"); ?>"
                                target="_blank">Glossário
                                - PS</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - QM.pdf"); ?>"
                                target="_blank">Glossário
                                - QM</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - SD.pdf"); ?>"
                                target="_blank">Glossário
                                - SD</a></li>
                        <li><a href="<?= base_url("_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - TM.pdf"); ?>"
                                target="_blank">Glossário
                                - TM</a></li>
                    </ul>
                </div>
            ...
            <div class="como_acessar">
                ...
                <div class="box_container">
                    <div class="box_acessar">
                        <div class="container">
                            <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Base3.png"); ?>"
                                alt="como_acessar" class="como_acessar1">
    ...
    <div id="centralSuporte">
        <div class="central_de_suporte">
            <img src="<?= base_url("_assets/landing-pages/metamorfose/images/Separacao01.png"); ?>" alt="central"
                class="local_central">
    ...
    <div class="footer-container">
        <div class="footer-images">
            <img src="<?= base_url("_assets/landing-pages/metamorfose/images/02.png"); ?>" alt="Imagem 02"
                class="imagem02">
            <img src="<?= base_url("_assets/landing-pages/metamorfose/images/05.png"); ?>" alt="Imagem 03"
                class="imagem03">
        </div>
