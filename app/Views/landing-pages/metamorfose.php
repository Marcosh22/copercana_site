...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url("_assets/landing-pages/metamorfose/css/style.css") ?>?v=<?= filemtime("_assets/landing-pages/metamorfose/css/style.css") ?>">
...
<body>
    ...
    <header class="header">
        <div class="logo-container">
            <div class="logo">
                <!-- Alteração do link para "#" para voltar ao topo -->
    ...
    <div id="container">
        ...
        <div id="video-container" style="display: none;">
            <video id="video" width="680" height="480" controls>
                <source src="<?= base_url('_assets/landing-pages/metamorfose/video/VT-MissaoMeta_bx.mp4'); ?>" type="video/mp4">
            </video>
            ...
            <div id="popup" class="popup">
                <div class="popup-content">
                    ...
                    <ul class="download-menu">
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - BP.pdf'); ?>" target="_blank">Glossário
                                - BP</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - CO.pdf'); ?>" target="_blank">Glossário
                                - CO</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - CS.pdf'); ?>" target="_blank">Glossário
                                - CS</a></li>
                        ...
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - FI.pdf'); ?>" target="_blank">Glossário
                                - FI</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - MM.pdf'); ?>" target="_blank">Glossário
                                - MM</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - PM.pdf'); ?>" target="_blank">Glossário
                                - PM</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - PP.pdf'); ?>" target="_blank">Glossário
                                - PP</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - PS.pdf'); ?>" target="_blank">Glossário
                                - PS</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - QM.pdf'); ?>" target="_blank">Glossário
                                - QM</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - SD.pdf'); ?>" target="_blank">Glossário
                                - SD</a></li>
                        <li><a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Projeto CoperSAP - Glossário SAP - TM.pdf'); ?>" target="_blank">Glossário
                                - TM</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div id="centralSuporte">
        ...
        <div id="Botão1">
            <div class="guia_suporte">
                <h2 class="central_titulo1">Guia de Suporte</h2>
                <a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Guia de Suporte para Usuários SAP - ATUALIZADO.pdf'); ?>" target="_blank">
                    <img src="<?= base_url('_assets/landing-pages/metamorfose/images/ButtonsMedium.png'); ?>" alt="Suporte" class="guia_suporte">
                </a>
        ...
        <div id="Botão2">
            <div class="guia_suporte">
                <h2 class="central_titulo2">Lista de Contatos</h2>
                <a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Contatos de Suporte - Agentes de Transformação - ATUALIZADO.xlsx'); ?>"
                    target="_blank">
                    <img src="<?= base_url('_assets/landing-pages/metamorfose/images/ButtonsMedium2.png'); ?>" alt="Suporte" class="guia_suporte">
                </a>
            </div>
        </div>
    </div>
    <div id="Botão2">
        <div class="guia_suporte">
            <h2 class="central_titulo3">Material de Apoio</h2>
            <a href="<?= base_url('_assets/landing-pages/metamorfose/manual/Verificação de Perfil de Acesso e Solicitação de Usuários.pdf'); ?>" target="_blank">
                <img src="<?= base_url('_assets/landing-pages/metamorfose/images/ButtonsMedium2.png'); ?>" alt="Suporte" class="guia_suporte">
            </a>
        </div>
    </div>
    ...
    <div class="footer-container">
        ...
        <script
            src="<?= base_url("_assets/landing-pages/metamorfose/js/luz.js"); ?>?v=<?= filemtime("_assets/landing-pages/metamorfose/js/luz.js"); ?>"></script>
        <script
            src="<?= base_url("_assets/landing-pages/metamorfose/js/PopUp_Glossário.js"); ?>?v=<?= filemtime("_assets/landing-pages/metamorfose/js/PopUp_Glossário.js"); ?>"></script>
        <script
            src="<?= base_url("_assets/landing-pages/metamorfose/js/Regressiva.js"); ?>?v=<?= filemtime("_assets/landing-pages/metamorfose/js/Regressiva.js"); ?>"></script>
</body>
