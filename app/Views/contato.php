                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input class="c-input mask-cellphone" type="text" name="cellphone" id="cellphone"
                                        placeholder="Celular"
                                        value="<?= $form_data && $form_data['cellphone'] ? htmlentities($form_data['cellphone']) : '' ?>">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <input class="c-input" type="text" name="subject" id="subject" placeholder="Assunto"
                                        value="<?= $form_data && $form_data['subject'] ? htmlentities($form_data['subject']) : '' ?>">
                                </div>
                                <div class="col-12">
                                    <textarea class="c-textarea" name="message" id="message" placeholder="Mensagem"
                                        rows="8"><?= $form_data && $form_data['message'] ? htmlentities($form_data['message']) : '' ?></textarea>
                                </div>
