...
$routes->get('/servicos/lojas-copercana', 'Home::ferragem_magazine');
$routes->addRedirect('/servicos/ferragem-magazine', '/servicos/lojas-copercana');
...
$routes->get('/admin/truckcenter/services', 'Admin_Truckcenter_Services::index');
$routes->get('/admin/truckcenter/services/add_new', 'Admin_Truckcenter_Services::add_new');
$routes->post('/admin/truckcenter/services/add', 'Admin_Truckcenter_Services::add');
$routes->get('/admin/truckcenter/services/edit/(:num)', 'Admin_Truckcenter_Services::edit/$1');
$routes->post('/admin/truckcenter/services/update/(:num)', 'Admin_Truckcenter_Services::update/$1');
