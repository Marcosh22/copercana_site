...
class Admin_Events_Galleries extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('admin/events-galleries/index', $data);
    ...
    public function add_new()
    {
        ...
        echo view('admin/includes/header', $data);
        echo view('admin/events-galleries/add_new', $data);
        echo view('admin/includes/footer', $data);
    }
    ...
    public function edit($gallery_id)
    {
        ...
        echo view('admin/includes/header', $data);
        echo view('admin/events-galleries/edit', $data);
        echo view('admin/includes/footer', $data);
    }
    ...
    public function add_gallery() {
        ...
        if($success && $gallery_id) {
            return redirect()->to('/admin/events_galleries/edit/'.$gallery_id);
        } else {
            return redirect()->to('/admin/events_galleries/add_new');
        }
    }
    ...
    public function delete($gallery_id) {
        ...
        return redirect()->to('/admin/events_galleries');
    }
