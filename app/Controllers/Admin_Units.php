...
class Admin_Units extends BaseController
{
    ...
    public function truckcenter()
    {
        ...
        $data['page'] = 'units-truckcenter';
        $data['session'] = $session;
        $data['logged_user'] = $this->ionAuth->user();
        $data['ion_auth'] = $this->ionAuth;

        echo view('admin/includes/header', $data);
        echo view('admin/units/truckcenter/index', $data);
        echo view('admin/includes/footer', $data);
    }

    public function truckcenter_add_new()
    {
        helper(['form']);
        ...
        echo view('admin/includes/header', $data);
        echo view('admin/units/truckcenter/add_new', $data);
        echo view('admin/includes/footer', $data);
    }

    public function truckcenter_edit($unit_id)
    {
        helper(['form']);
        ...
        echo view('admin/includes/header', $data);
        echo view('admin/units/truckcenter/edit', $data);
        echo view('admin/includes/footer', $data);
    }
