window.onload = function () {
  ...
  if (navbar) {
    let distance = $(navbar).offset().top + $(navbar).outerHeight(true);
  ...
  let topMenu = $(".page-navigation__list");
  ...
  if (topMenu) {
    ...
    $(window).scroll(function () {
      ...
      menuItems
        .removeClass("page-navigation__link--active")
        .filter("[href='#" + id + "']")
        .addClass("page-navigation__link--active");
    });
  }

  let scroll_triggers = document.querySelectorAll(".js-scroll");

  scroll_triggers.forEach(function (el) {
    let scroll_el_id = el.getAttribute("data-target");
    let scroll_el = document.querySelector(scroll_el_id);
  ...
  $(".gallery__carousel").slick({
    ...
    autoplaySpeed: 2000,
    prevArrow:
      '<button class="custom-slick-arrow custom-slick-arrow--prev" aria-label="Previous Slide" type="button"><svg style="transform: rotate(90deg);" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-down" class="svg-inline--fa fa-chevron-down fa-w-14" role="img" viewBox="0 0 448 512" width="60" height="37.5"><path fill="#B6B6B6" d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"/></svg></button>',
    nextArrow:
      '<button class="custom-slick-arrow custom-slick-arrow--next" aria-label="Next Slide" type="button"><svg style="transform: rotate(-90deg);" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-down" class="svg-inline--fa fa-chevron-down fa-w-14" role="img" viewBox="0 0 448 512" width="60" height="37.5"><path fill="#B6B6B6" d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"/></svg></button>',
    responsive: [
      {
        breakpoint: 1200,
        settings: {
